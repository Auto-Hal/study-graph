...
function snapshotContentOf(value: ScopeKnowledgeSnapshot | ScopeKnowledgeSnapshotInput) {
...
/** Compare already-validated snapshots without selecting an authority from timestamps. */
export function compareVerifiedSnapshotAdoption(
